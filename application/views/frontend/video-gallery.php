        ...
        <ul id="menu">
            ...
            <li class="avtives">Digital Events
                <ul>
                    ...
                    <li>
                        <a href="<?php echo site_url(" website/event ")."?id=".$event->id; ?>">
            ...
            <div class="pic-cont">
                ...
                <div class="col-md-6">
                    <div class="pic-det dets pull-left">
                        <p>See what the leaders from the CDIT have to say.</p>
                        <br>
                    ...
                    <div class="col-md-6">
                        <div class="pic-set">
                            <select class="videoalbumselect">
                                ...
                                <option value="<?php echo $videoalbum->id; ?>">
                                    <?php echo $videoalbum->name; ?></option>
                                <?php }; ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div id="amazingslider-wrapper-1" style="display:block;position:relative;max-width:746px;padding-left:0px; padding-right:83px;margin:0px auto 0px;">
                            <div id="amazingslider-1" style="display:block;position:relative;margin:0 auto;">
                                ...
                                <ul class="amazingslider-thumbnails" style="display:none;">
                                    <li>
                                        <img src="<?php echo base_url(" frontend ")."/ " ?>images/tmeOjFno6Do-tn.jpg" alt="Marvel&apos;s &quot;Avengers: Age of Ultron&quot; - Teaser Trailer (OFFICIAL)" />
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url(" frontend ")."/ " ?>images/tMShlthBgKw-tn.jpg" alt="How To Install MIUI v6 on Xiaomi Redmi 1S" />
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url(" frontend ")."/ " ?>images/Yj0l7iGKh8g-tn.jpg" alt="The Flash - Extended Trailer" />
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url(" frontend ")."/ " ?>images/WFjABnTOGuI-tn.jpg" alt="Arrow - Stunts : Arrow vs. Ra&apos;s Al Ghul" />
                                    </li>
                                    <li>
                                        <img src="<?php echo base_url(" frontend ")."/ " ?>images/UWfd0boBMGM-tn.jpg" alt="Arrow Season 2 Bloopers" />
                                    </li>
                                </ul>
